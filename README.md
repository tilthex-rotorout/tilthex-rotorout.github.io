...
<p align="center">
  GitHub-friendly supplementary materials adapted from the project website.
</p>

<p align="center">
  <a href="https://tilthex-rotorout.github.io/"><strong>Live Website</strong></a>
  |
...
The sections below keep the most visual parts of the supplementary website directly inside the README while staying compatible with GitHub's static rendering.
...
The full website presents side-by-side hovering comparisons across fault cases, tilt angles, and controller or allocator designs. In the README, the same material is condensed into expandable tables so the repository homepage stays readable while still exposing all experiment entries.
...
- GitHub README files cannot preserve the full CSS and JavaScript behavior of the original supplementary website, so videos are presented here as clickable posters and compact tables.
- For the full interactive layout and all side-by-side media blocks, open the project website at <https://tilthex-rotorout.github.io/>.
